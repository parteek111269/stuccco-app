...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "ionic-angular", "rxjs/Rx", "./image-viewer-transitions"], factory);
    }
    ...
    var ImageViewerImpl = (function (_super) {
        ...
        ImageViewerImpl.prototype.handleHighResImageLoad = function (fullResImage) {
            ...
            if (!image.complete) {
                var onLoadObservable = Rx_1.Observable.create(function (obs) {
                ...
                Rx_1.Observable.zip(onLoadObservable, this.didEnter)
