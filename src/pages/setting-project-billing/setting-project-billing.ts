...
@IonicPage()
@Component({
  selector: 'page-setting-project-billing',
  templateUrl: 'setting-project-billing.html',
})
export class SettingProjectBillingPage {
    ...
    ionViewDidLoad() {
      console.log('ionViewDidLoad SettingProjectBillingPage');
    }
